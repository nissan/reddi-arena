...
- `core/assurance.py` — local Solana Devnet Preview / RAP Assurance fixture adapter; submits nothing
...
python3 tests/test_arena.py            # 529 checks — must pass before any PR
